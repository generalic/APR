...
import hr.fer.zemris.apr.lab2.functions.Function1;
import hr.fer.zemris.apr.lab2.functions.Function2;
import hr.fer.zemris.apr.lab2.functions.Function3;
...
public class Task2 {
    ...
    private static void run() {
        List<IFunction> functions = Arrays.asList(
                new Function1(new double[]{-1.9, 2}),
                new Function2(new double[]{0.1, 0.3}),
                new Function3(new double[]{0, 0, 0, 0, 0}),
                new Function4(new double[]{5.1, 1.1}),
