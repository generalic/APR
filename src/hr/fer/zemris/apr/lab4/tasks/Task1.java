...
import hr.fer.zemris.apr.lab4.function.Function1;
import hr.fer.zemris.apr.lab4.function.Function3;
...
//        function7();
    ...
    private static void function1() {
        ...
        Decoder decoder = new Decoder(
                IntStream.range(0, 2).mapToDouble(i -> -50).toArray(),
                IntStream.range(0, 2).mapToDouble(i -> 150).toArray()
        );
        IFunction f = new Function1(new double[]{-1.9, 2});
        ...
        System.out.println("\nGenerative solution for f1: " + solution + ", " + solution.getFitness());
//        System.out.println("Eliminative solution for f1: " + sol12 + ", " + sol12.getFitness());
    ...
    private static void function1Binary() {
        ...
        BitVectorSolution solution = ga.run();
    ...
    private static void function3() {
        ...
        Decoder decoder = new Decoder(
                IntStream.range(0, 5).mapToDouble(i -> -50).toArray(),
                IntStream.range(0, 5).mapToDouble(i -> 150).toArray()
        );
        IFunction f = new Function3(new double[]{0, 0, 0, 0, 0});
    ...
    private static void function6() {
        ...
        IFunction f = new Function6(new double[]{0, 0});
    ...
    private static void function7() {
        ...
        IFunction f = new Function7(new double[]{0, 0});
